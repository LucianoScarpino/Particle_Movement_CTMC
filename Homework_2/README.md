...
* `Ex2_convergence.py` — **Problem 2**
  * Addendum to `Ex2.py` which focuses on convergence analysis.
  * Simulates convergence of return time estimates as number of particles increases fixing either number of iterations or time horizon. 
  * Saves plots under `Homework_2/plots/`.
